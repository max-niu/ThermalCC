...
parser = argparse.ArgumentParser(description='ThermalCC')
...
parser.add_argument('--save_path', type=str, default='train_results/dronergbt',
...
parser.add_argument('--pre', type=str, default='./train_results/dronergbt/model_best.pth',
                    help='pre-trained model directory')
